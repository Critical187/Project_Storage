...
public class Mandelbrot implements Runnable{
    ...
    private BoolFunction isStopped;

    Mandelbrot(Tile tile, PixelManager pm, CountDownLatch signal, BoolFunction getIsStopped) {
        this.tile = tile;
        this.pm = pm;
        this.signal = signal;
        this.isStopped = getIsStopped;
    }
